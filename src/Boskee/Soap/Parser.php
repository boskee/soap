...
/**
 * Boskee\Soap\Parser class parses SOAP XML messages into native PHP values.
 *
...
class Parser extends Base
{
    ...
    public function __construct($xml, $encoding = 'UTF-8', $method = '', $decode_utf8 = true)
    {
        ...
        if (!empty($xml)) {
            ...
            $this->debug('Entering Boskee\Soap\Parser(), length='.strlen($xml).', encoding='.$encoding);
            ...
            if (!xml_parse($this->parser, $xml, true)) {
                ...
                $this->debug('in Boskee\Soap\Parser ctor, message:');
