 ...
 * Boskee\Soap\Base.
 *
 * @author   Wojciech Zylinski <voitek@boskee.co.uk>
...
abstract class Base
{
     ...
     * @access private
     */
    protected $revision = '$Revision: 1.124 $';
    /*
    ...
    * is this legacy yet?
    * no, this is used by the Boskee\Soap\XMLSchema class to verify type => namespace mappings.
    * @var      array
    * @access   public
    */
    ...
    public function serialize_val($val, $name = false, $type = false, $name_ns = false, $type_ns = false, $attributes = false, $use = 'encoded', $soapval = false)
    {
        ...
        if (is_object($val) && get_class($val) == 'Boskee\Soap\SoapVal' && (!$soapval)) {
        ...
        switch (true) {
            ...
            case is_object($val):
                ...
                if (get_class($val) == 'Boskee\Soap\SoapVal') {
